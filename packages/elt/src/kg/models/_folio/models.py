...
class OWLClass(BaseModel):
    ...
    @classmethod
    def model_validate(cls, obj: Any) -> "OWLClass":
        """
        Validate and create an OWLClass instance from a dictionary or object.
        """
    ...
    @classmethod
    def model_validate_json(cls, json_str: str) -> "OWLClass":
        """
        Validate and create an OWLClass instance from a JSON string.
        """
